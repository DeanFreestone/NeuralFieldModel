...
Here to compute Gamma Matrix, we compute inner product between each Gaussian basis
function by calling local function \textit{InnerProductTwo2DGaussians.m}. The inner
product of two Gaussian basis function is define in Equation (D.3) Appendix D.\par
The local function, \textit{InnerProductTwo2DGaussians.m}, analytically compute the
integration of two Gaussian basis functions over the space.
