...
In order to switch between two different types of connectivity kernels,
we parameterised connectivity kernels as centres of basis functions, \textit{mu_psi},
and variance-covariane matrix, \textit{}.\newline
