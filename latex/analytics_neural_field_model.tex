...
$$\varphi_i\otimes\varphi_j=\int_{\mathbb{R}^\mathbb{N}}\varphi_i(r)\varphi_j(r)\,dr,$$ in Equation (D.3) Appendix D.\par
...
% Compute Psi
\section{Compute Psi}
\paragraph{We will compute Psi Matrix, according to Equation (24) XXX. In this section, we
